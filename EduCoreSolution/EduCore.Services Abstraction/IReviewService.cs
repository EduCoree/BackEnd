...
namespace EduCore.Services_Abstraction
{
    public interface IReviewService
    {
        ...
        Task<IEnumerable<ReviewDto>> GetTeacherReviewsAsync(string teacherId, int? courseId = null, int? minRating = null);
        Task<IEnumerable<ReviewDto>> GetStudentReviewsAsync(string studentId);
        Task DeleteReviewByTeacherAsync(string teacherId, int reviewId);
